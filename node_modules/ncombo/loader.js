var $loader = {
	...
	init: function(frameworkURL, routToScriptURL, loadScriptURL, resources, resourceProps, appDefinition, skipPreload) {
		...
		$loader._resourceProps = resourceProps;
	...
	_embedAllResources: function() {
		if($loader._embedCounter < $loader._resources.length) {
			...
			if(/[.]js$/.test(url)) {
				if($loader._resourceProps[url]) {
					type = $loader._resourceProps[url].type;
				}
				if(!type) {
				...
				if($loader._resourceProps[url]) {
					type = $loader._resourceProps[url].type;
					rel = $loader._resourceProps[url].rel;
				}
				if(!type) {
					type = 'text/css';
				}
