...
var Router = new (function() {
	...
	self.start = function(options) {
		if(options) {
			self._cacheMode = options.release ? true : false;
			if(options.protocol) {
				self._protocol = options.protocol;
			}
			if(options.privateExtensionRegex) {
				self._privateExtension = options.privateExtensionRegex;
			}
			if(options.rootDirPath) {
				self._rootDirPath = options.rootDirPath;
			}
		}
	}
