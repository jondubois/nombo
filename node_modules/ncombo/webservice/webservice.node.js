...
var WebService = function() {
	...
	self.exec = function(ioReq, ioRes) {
		var client = self.getClient(ioReq.host, ioReq.port, ioReq.secure, ioReq.wsEndpoint);
		...
		if(client.ns(ioReq.ns).isWatching(ioReq.event)) {
			...
			client.ns(ioReq.ns).watch(ioReq.event, handler, function(err) {
				if(err) {
					...
					self._watchMap[id].push({ns: ioReq.ns, event: ioReq.event, client: client, handler: handler});
