...
NCOMBO_SOCKET.socket.on('error', function(err) {
	...
	if(err == 'handshake error') {
		...
		limitScript.src = smartCacheManager.setURLCacheVersion('/node_modules/ncombo/scripts/connectionlimit.js');
		head.appendChild(limitScript);
	}
});

var cacheCookieName = 'nccachecookie';
var NCOMBO_IS_FRESH = getCookie(cacheCookieName) ? false : true;

setCookie(cacheCookieName, '1', 31556909);
