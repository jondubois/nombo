...
nData.prototype.publish = function (name) {
	var args = Array.prototype.slice.call(arguments, 1);
	this._dataClient.broadcast('__store.events.' + name, {nodeId: this.nodeId, args: args});
...
nData.prototype.subscribe = function (name, consumer, fn) {
	...
	self._dataClient.watchOnce('__store.events.' + name, function subscribe(data) {
