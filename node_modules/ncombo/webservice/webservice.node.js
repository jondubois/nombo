...
var WebServiceClient = function(host, port, secure, wsEndpoint) {
	...
	self._disconnect = function(callback) {
		if(self._wsSocket) {
	...
	self._unwatchAll = function(ackCallback) {
		var i;
		var nsCount = 0;
		var nsSuccess = 0;
...
var WebService = function() {
	...
	self.watch = function(siReq) {
		...
		if(client.ns(siReq.ns).hasWatcher(siReq.event)) {
			siReq.end();
		} else {
