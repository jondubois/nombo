		...
		var begin = function() {
			...
			if(self._options.maxConnectionsPerAddress > 0) {
				self._io.set('authorization', function(handshakeData, callback) {
					...
					if(!self._connectedAddresses.hasOwnProperty(remoteAddr)) {
						self._connectedAddresses[remoteAddr] = 0;
					}
					if(self._connectedAddresses[remoteAddr] < self._options.maxConnectionsPerAddress) {
						...
						self._dataClient.get('__opensockets', function(err, data) {
							console.log('socks', data);
						});
