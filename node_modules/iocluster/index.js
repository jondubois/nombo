...
Global.prototype.emit = function (sessionId, event, data, callback) {
	this._dataClient.broadcast(this._keyManager.getSessionEventKey(sessionId), {ns: this._namespace, session: sessionId, event: event, data: data, exclude: this.socketId}, callback);
};
